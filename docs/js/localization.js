...
const translations = {
    ja: {
        ...
        qrMainScreen: "速読画面",
        qrMainScreenDesc: "チャンク表示で読み進める速読インターフェース",
        qrBookshelfScreen: "本棚画面",
        qrBookshelfScreenDesc: "読み込んだ本を一覧管理",
        qrNaroScreen: "なろう検索画面",
        qrNaroScreenDesc: "小説家になろうの作品を検索・ダウンロード",
        qrSettingsScreen: "設定画面",
        qrSettingsScreenDesc: "テーマや速度などを自分好みに調整",
    ...
    en: {
        ...
        qrMainScreenDesc: "The chunked speed-reading interface",
        qrBookshelfScreen: "Bookshelf Screen",
        qrBookshelfScreenDesc: "Manage all your imported books",
        qrNaroScreen: "Narou Search Screen",
        qrNaroScreenDesc: "Search and download novels from Shousetsuka ni Narou",
        qrSettingsScreen: "Settings Screen",
        qrSettingsScreenDesc: "Adjust theme, speed, and more to your liking",
    ...
    zh: {
        ...
        qrMainScreen: "速读界面",
        qrMainScreenDesc: "分块显示的速读界面",
        qrBookshelfScreen: "书架界面",
        qrBookshelfScreenDesc: "管理已导入的所有书籍",
        qrNaroScreen: "「成为小说家」搜索界面",
        qrNaroScreenDesc: "搜索并下载「成为小说家」上的作品",
        qrSettingsScreen: "设置界面",
        qrSettingsScreenDesc: "自定义主题、速度等设置",
